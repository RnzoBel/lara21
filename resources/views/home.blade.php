        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('showapps') }}" class="btn btn-block btn-outline-primary btn-sm">Agregar
                            Aplicativos</a>
                                ...
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <img class="img-responsive" src="{{ 'img/' . $item->idaplicacion . '.png' }}"
                                                width="150" height="150" alt="Lanzar aplicacion Municipal"><br>
